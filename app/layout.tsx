...
export const metadata: Metadata = {
  title: "GcpTrainer - Keep your GCP sharp",
  description:
    "Spaced repetition, lessons and exercises to master Google Cloud Platform.",
};
...
(function () {
  try {
    var pref = localStorage.getItem("gcptrainer.theme") || "system";
    var dark = pref === "dark" ||
