...
const THEME_KEY = "gcptrainer.theme";

function getPersistedTheme(): ThemePref {
...
export default function SettingsPage() {
  ...
  const [theme, setTheme] = useHydratedState(getPersistedTheme, "system" as ThemePref);
  const [passphrase, setPassphraseInput] = useHydratedState(getPassphrase, "");
  const [saving, setSaving] = useState(false);

  // Synchronize the DOM with the theme preference (the inline bootstrap
  // script in layout.tsx handles the pre-hydration paint; this keeps it
  // in sync afterwards, e.g. when the user picks a new theme or the OS
